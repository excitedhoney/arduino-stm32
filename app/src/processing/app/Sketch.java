...
import processing.app.debug.Stm32Uploader;
import processing.app.debug.Compiler;
import processing.app.debug.CompilerARM;
...
//        sc.setPreprocName(filename);
  ...
  public String build(String buildPath, Target target, boolean verbose)
    ...
    Compiler compiler;
    if (Preferences.get("boards." + Preferences.get("board") + ".build.mcu").equals("cortex-m3"))
...
//    }
  ...
  protected String upload(String buildPath, String suggestedClassName, boolean verbose)
    ...
    //
    if (Preferences.get("boards." + Preferences.get("board") + ".build.core").equals("stm32"))
        uploader = new Stm32Uploader();
    else
